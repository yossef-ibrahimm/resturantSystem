...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --page "dashboard" --output-dir "<project-root>"
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <stack>
```

Example for a known React Native implementation concern:

```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "virtualized list" --stack react-native
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "atlantafx primer enterprise theme" --stack javafx
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "enterprise tableview density permission" --stack javafx
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"
```
...
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "minimalism dark mode" --domain style

# Get UX best practices for search interaction and loading
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "search loading animation" --domain ux
```

### Step 4: Stack Guidelines

```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "streaming suspense" --stack nextjs
```
...
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system

# Markdown - best for documentation
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system -f markdown
```
